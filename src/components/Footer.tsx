...
const Footer = () => {
  ...
  const sectionPaddingX = r('16px', '20px', '40px', '60px', '80px');
  const sectionPaddingY = r('40px', '50px', '60px', '80px', '100px');
  const titleFontSize = r('16px', '18px', '20px', '22px', '24px');
  ...
  const inputWidth = isMobile ? '100%' : '228px';
  const inputHeight = r('36px', '38px', '40px', '40px', '40px');
  const qrSize = r('100px', '110px', '120px', '130px', '144px');
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        gap: r('20px', '24px', '30px', '40px', '40px'),
        background: '#f4f5f6',
        padding: `${sectionPaddingY} ${sectionPaddingX} ${r('20px', '30px', '40px', '50px', '60px')}`,
        ...
        <div style={{
          ...
          flexDirection: 'column',
          alignItems: 'flex-start',
          rowGap: r('12px', '14px', '16px', '18px', '20px'),
          width: colWidth,
          minWidth: isMobile ? '0' : '180px',
          flex: isMobile ? '1 1 100%' : isTablet ? '1 1 48%' : '0 1 auto',
        }}>
          <p style={{
            letterSpacing: 0,
            color: '#1d2233',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: '#000000',
              fontFamily: '"Noto Sans SC", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", SimHei, Arial, Helvetica, sans-serif',
              fontSize: r('12px', '13px', '14px', '15px', '16px'),
            }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  ...
                  onBlur={() => { validatePhone(); setFocusedPhone(false); }}
                  ...
                  style={{
                    ...
                    opacity: phone ? 1 : (hoveredPhone || focusedPhone) ? 1 : 0.7,
                    letterSpacing: 0,
                    color: '#000000',
                    fontFamily: '"Noto Sans SC", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", SimHei, Arial, Helvetica, sans-serif',
                    fontSize: r('13px', '14px', '14px', '15px', '16px'),
                    outline: 'none',
                    boxSizing: 'border-box',
              ...
              {phoneError && (
                <p style={{ color: '#ff0000', fontSize: '12px', margin: '0' }}>{phoneError}</p>
              )}
              ...
              <div style={{
                ...
                <input
                  ...
                  onBlur={() => { validateShopType(); setFocusedShopType(false); }}
                  ...
                  style={{
                    ...
                    opacity: shopType ? 1 : (hoveredShopType || focusedShopType) ? 1 : 0.7,
                    letterSpacing: 0,
                    color: '#000000',
                    fontFamily: '"Noto Sans SC", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", SimHei, Arial, Helvetica, sans-serif',
                    fontSize: r('13px', '14px', '14px', '15px', '16px'),
              ...
              {shopTypeError && (
                <p style={{ color: '#ff0000', fontSize: '12px', margin: '0' }}>{shopTypeError}</p>
              )}
              ...
              <div style={{
                ...
                <img
                  src="./image/mpw1s00i-u8nhqlk.svg"
                  style={{
                    position: 'absolute',
                    top: '50%',
                    right: '10px',
                    marginTop: `-${Math.round(parseInt(inputHeight as string) / 4)}px`,
                    width: '16px',
                    height: '17px',
                ...
                {showProvinceDropdown && (
                  <div style={{
                    position: 'absolute',
                    top: `${parseInt(inputHeight as string) + 5}px`,
                    left: 0,
                    width: '100%',
                    background: '#ffffff',
                    ...
                    {provinces.map((province, index) => (
                      <div
                        ...
                        style={{
                          ...
                          fontSize: r('12px', '13px', '14px', '14px', '14px'),
                        }}
              ...
              <div style={{
                position: 'relative',
                width: r('80px', '85px', '90px', '95px', '100px'),
                height: inputHeight,
                marginTop: '4px',
              }}>
                <div style={{
        ...
        <div style={{
          ...
          gap: r('16px', '20px', '24px', '30px', '30px'),
          width: colWidth,
          flex: isMobile ? '1 1 100%' : isTablet ? '1 1 48%' : '0 1 auto',
        }}>
          {/* 官方公众号 */}
          <div style={{
            ...
            <div style={{
              ...
              <img
                src="./image/mpw1rbtk-s5recnr.png"
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img
                src="./image/mpw1rbtk-mj4mlxj.png"
                style={{ width: qrSize, height: qrSize }}
                alt=""
              />
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img
                src="./image/mpw1rbtk-90n2blm.png"
                style={{ width: qrSize, height: qrSize }}
                alt=""
              />
            </div>
      ...
      <div style={{
        ...
        justifyContent: 'center',
        background: '#f4f5f6',
        padding: r('16px', '20px', '24px', '28px', '30px') + ' ' + sectionPaddingX,
        rowGap: '6px',
        boxSizing: 'border-box',
